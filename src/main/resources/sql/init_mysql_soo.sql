...
INSERT INTO `sys_menu` VALUES ('12', '分页列表', '/sys/log/page', '2021-01-06 18:14:12', '2021-01-06 18:14:15', NULL);
INSERT INTO `sys_menu` VALUES ('19cc7658c3ad1bd6cfb657a201e18710', '编辑菜单', '/menu/update', '2021-01-11 13:55:04', '2021-01-11 13:55:04', '');
INSERT INTO `sys_menu` VALUES ('1e74f04e75c51fe5a00c8ee3308c5935', '删除角色', '/role/delete', '2021-01-11 13:56:31', '2021-01-11 13:56:31', '');
...
INSERT INTO `sys_menu` VALUES ('31266da86090d900bd873276fb737b28', '分页列表', '/menu/page', '2021-01-11 16:46:21', '2021-01-11 16:46:21', '');
INSERT INTO `sys_menu` VALUES ('3e320d07d905c8fe8b3d325eddacfd88', '添加菜单', '/menu/save', '2021-01-11 13:54:54', '2021-01-11 13:54:54', '');
INSERT INTO `sys_menu` VALUES ('4', '分页列表', '/user/page', '2021-01-05 14:53:43', '2021-01-05 14:53:45', NULL);
...
INSERT INTO `sys_menu` VALUES ('82b52c6fab80d28bdb65b0b00c100f24', '修改角色', '/role/update', '2021-01-11 13:56:08', '2021-01-11 13:56:08', '');
INSERT INTO `sys_menu` VALUES ('9', '删除任务', '/task/delete', '2021-01-06 11:32:27', '2021-01-06 11:32:39', NULL);
INSERT INTO `sys_menu` VALUES ('a04d17ba1b1c9c1197f2073959289bdd', '删除菜单', '/menu/delete', '2021-01-11 13:55:14', '2021-01-11 13:55:14', '');
INSERT INTO `sys_menu` VALUES ('cff723434fb2e5d770c6b0268937f7d4', '分页列表', '/role/page', '2021-01-11 13:57:06', '2021-01-11 13:57:06', '');
INSERT INTO `sys_menu` VALUES ('e3def5aaa795e4017ac70b82fd70a8f9', '添加角色', '/role/save', '2021-01-11 13:55:59', '2021-01-11 13:55:59', '');
...
`handler_time` bigint(10) NULL DEFAULT NULL COMMENT '操作时间',
PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_role` VALUES ('48f214c0bfbdc43b32a354cb497ef946', '菜单管理', '2021-01-11 13:59:21', '2021-01-11 13:59:21');
INSERT INTO `sys_role` VALUES ('5b85dd05b0777da3741f29bb964fa359', '角色管理', '2021-01-11 13:58:57', '2021-01-11 13:58:57');
